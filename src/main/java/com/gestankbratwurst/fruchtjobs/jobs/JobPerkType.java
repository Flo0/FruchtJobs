...
public enum JobPerkType {
  ...
  THE_HUNT_MUST_GO_ON("Jagdinstinkt", Model.THE_HUNT_MUST_GO_ON_ICON.getItem(),
      ...
      JobType.FARMER, 9),
  RECIPE_FLOUR_BIOMASS("Rezepte: §eMehl und Biomasse", Model.BIOMASS.getItem(),
      new String[]{"§fBeschreibung", "§fkommt noch."},
      JobType.FARMER, 13),
  RECIPES_BUTTER_AND_CLOTH("Rezepte: §eButter und Stoff", Model.CLOTH.getItem(),
      new String[]{"§fBeschreibung", "§fkommt noch."},
      JobType.FARMER, 13),
  HEADHUNTER("Headhunter", new ItemStack(Material.ZOMBIE_HEAD),
      new String[]{"§fBeschreibung", "§fkommt noch."},
      JobType.FARMER, 13),
