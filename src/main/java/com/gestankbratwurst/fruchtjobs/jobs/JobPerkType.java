...
public enum JobPerkType {
  ...
  STONE_HUNTER("Steinsammler", new ItemStack(Material.DIORITE),
      new String[]{"§fDu erhälst alle §e20", "§fSteine §e20 §fzusätzliche", "§fErfahrung."},
      JobType.GATHERER, 5),
  ...
  TREE_HUNTER("Holzsammler", new ItemStack(Material.OAK_WOOD),
      new String[]{"§Bäume geben §e10%§f mehr", "§fErfahrung."},
      JobType.GATHERER, 5),
  ...
  CAVE_DIVER("Höhlentaucher", Model.CAVE_DIVER_ICON.getItem(),
      new String[]{"§fWenn du dich unter der", "§fHöhe §e70 §fbewegst, erhälst", "§fdu einen §eSpeed I§f Buff."},
      JobType.GATHERER, 8),
  ...
  BETTER_BUTCHER("Bessere Tierhaltung", new ItemStack(Material.WHITE_WOOL),
      new String[]{"§fSchlachten: §e+10% Exp", "§fScheeren: §e+20% Exp", "§fMelken: §e+37.5% Exp", "§fVermehren: §e+42.5%Exp"},
      JobType.FARMER, 3),
  ...
  LEARNED_BUTCHER("Gelerntes schlachten", Model.FILLET.getItem(),
      new String[]{"§fZusätzliche Drops:", "§f- Fillet bei Kühen, Schweinen, Schafen, Hasen", "§f- Federn bei Hühnern",
          "§f- Schnur beim Scheeren"},
      JobType.FARMER, 9),
  ...
  SPADE_FINDINGS("Schaufelfunde", Model.SPADE_FINDINGS_ICON.getItem(),
      new String[]{"§fViele zusätzliche Drops", "§faus allen Erden."},
