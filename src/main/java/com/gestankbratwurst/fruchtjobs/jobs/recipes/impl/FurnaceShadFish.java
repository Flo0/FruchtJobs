 ...
 *
 */
public class FurnaceShadFish implements IFurnaceRecipe {

  @Override
  public RecipeChoice getInput() {
    return new ExactChoice(ItemLibrary.SHAD.getItem());
  }
  ...
  public String getDisplayName(Player player) {
    return ItemLibrary.COOKED_SHAD.getItem().getItemMeta().getDisplayName();
  }
}
