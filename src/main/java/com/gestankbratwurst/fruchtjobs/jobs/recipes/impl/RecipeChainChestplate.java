 ...
 *
 */
public class RecipeChainChestplate extends AbstractJobShapedRecipe {

  public RecipeChainChestplate(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 0, JobPerkType.RECIPES_CHAINS);
    shape = new String[]{"C C", "CCC", "CCC"};
    desc = new ArrayList<>();
  ...
  public ItemStack getResult() {
    return ItemLibrary.CHAIN_CHESTPLATE.getItem();
  }
