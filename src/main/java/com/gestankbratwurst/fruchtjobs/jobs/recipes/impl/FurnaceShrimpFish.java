 ...
 *
 */
public class FurnaceShrimpFish implements IFurnaceRecipe {

  @Override
  public RecipeChoice getInput() {
    return new ExactChoice(ItemLibrary.SHRIMP.getItem());
  }
  ...
  public ItemStack getResult() {
    return ItemLibrary.COOKED_SHRIMP.getItem();
  }
  ...
  public String getDisplayName(Player player) {
    return ItemLibrary.COOKED_SHRIMP.getItem().getItemMeta().getDisplayName();
  }
}
