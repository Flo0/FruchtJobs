 ...
 *
 */
public class RecipeChainLeggins extends AbstractJobShapedRecipe {

  public RecipeChainLeggins(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 0, JobPerkType.RECIPES_CHAINS);
    shape = new String[]{"CCC", "C C", "C C"};
    desc = new ArrayList<>();
  ...
  public ItemStack getResult() {
    return ItemLibrary.CHAIN_LEGGINS.getItem();
  }
