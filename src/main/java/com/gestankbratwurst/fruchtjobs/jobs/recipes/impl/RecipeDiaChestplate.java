 ...
 *
 */
public class RecipeDiaChestplate extends AbstractJobShapedRecipe {

  public RecipeDiaChestplate(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 13);
  }

  @Override
  protected List<String> evalDescription(Player player) {
    return Lists.newArrayList("§7Normaler Dia Brustpanzer.");
  }
  ...
  public void onCraft(Player player, int amount) {
    jobManager.getOnlineHolder(player).addExp(JobType.CRAFTER, 80);
  }
