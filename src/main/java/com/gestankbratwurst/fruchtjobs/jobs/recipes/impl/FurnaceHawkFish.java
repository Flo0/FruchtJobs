 ...
 *
 */
public class FurnaceHawkFish implements IFurnaceRecipe {

  @Override
  public RecipeChoice getInput() {
    return new ExactChoice(ItemLibrary.HAWK_FISH.getItem());
  }
  ...
  public ItemStack getResult() {
    return ItemLibrary.COOKED_HAWK_FISH.getItem();
  }
  ...
  public String getDisplayName(Player player) {
    return ItemLibrary.COOKED_HAWK_FISH.getItem().getItemMeta().getDisplayName();
  }
}
