 ...
 *
 */
public class RecipeIronArrow extends AbstractJobShapedRecipe {

  public RecipeIronArrow(JobManager jobManager) {
  ...
  public ItemStack getResult() {
    ItemStack item = ItemLibrary.IRON_ARROW.getItem();
    item.setAmount(4);
    return item;
  }
  ...
  public void onCraft(Player player, int amount) {
    jobManager.getOnlineHolder(player).addExp(JobType.CRAFTER, amount * 16);
  }
