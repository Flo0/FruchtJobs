 ...
 *
 */
public class RecipeDiaBoots extends AbstractJobShapedRecipe {

  public RecipeDiaBoots(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 13);
  }

  @Override
  protected List<String> evalDescription(Player player) {
    return Lists.newArrayList("§7Normale Dia Stiefel.");
  }
  ...
  public void onCraft(Player player, int amount) {
    jobManager.getOnlineHolder(player).addExp(JobType.CRAFTER, 40);
  }
