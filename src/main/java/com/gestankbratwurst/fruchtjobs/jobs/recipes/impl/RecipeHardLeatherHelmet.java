 ...
 *
 */
public class RecipeHardLeatherHelmet extends AbstractJobShapedRecipe {

  public RecipeHardLeatherHelmet(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 0, JobPerkType.RECIPES_HARD_LEATHER);
    shape = new String[]{"HHH", "H H"};
    desc = new ArrayList<>();
  ...
  public ItemStack getResult() {
    return ItemLibrary.HARD_LEATHER_HELMET.getItem();
  }
