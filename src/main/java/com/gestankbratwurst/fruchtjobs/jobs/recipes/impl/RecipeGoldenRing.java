 ...
 *
 */
public class RecipeGoldenRing extends AbstractJobShapedRecipe {

  public RecipeGoldenRing(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 0, JobPerkType.GOLD_SMITH);
    shape = new String[]{" G ", "G G", " G "};
    desc = new ArrayList<>();
  ...
  public ItemStack getResult() {
    return ItemLibrary.GOLDEN_RING.getItem();
  }

  @Override
  public void onCraft(Player player, int amount) {
    jobManager.getOnlineHolder(player).addExp(JobType.CRAFTER, amount * 64);
  }
