 ...
 *
 */
public class RecipeHardLeatherChestplate extends AbstractJobShapedRecipe {

  public RecipeHardLeatherChestplate(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 0, JobPerkType.RECIPES_HARD_LEATHER);
    shape = new String[]{"H H", "HHH", "HHH"};
    desc = new ArrayList<>();
  ...
  public ItemStack getResult() {
    return ItemLibrary.HARD_LEATHER_CHESTPLATE.getItem();
  }

  @Override
  public void onCraft(Player player, int amount) {
    jobManager.getOnlineHolder(player).addExp(JobType.CRAFTER, amount * 80);
  }

  @Override
  public String getName() {
    return "hardleatherchestplate";
  }
}
