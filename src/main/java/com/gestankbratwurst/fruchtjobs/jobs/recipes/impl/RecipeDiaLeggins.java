 ...
 *
 */
public class RecipeDiaLeggins extends AbstractJobShapedRecipe {

  public RecipeDiaLeggins(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 13);
  }

  @Override
  protected List<String> evalDescription(Player player) {
    return Lists.newArrayList("§7Normale Dia Beinschienen.");
  }
  ...
  public void onCraft(Player player, int amount) {
    jobManager.getOnlineHolder(player).addExp(JobType.CRAFTER, 70);
  }
