 ...
 *
 */
public class RecipeHardLeatherLeggins extends AbstractJobShapedRecipe {

  public RecipeHardLeatherLeggins(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 0, JobPerkType.RECIPES_HARD_LEATHER);
    shape = new String[]{"HHH", "H H", "H H"};
    desc = new ArrayList<>();
  ...
  public ItemStack getResult() {
    return ItemLibrary.HARD_LEATHER_LEGGINS.getItem();
  }
