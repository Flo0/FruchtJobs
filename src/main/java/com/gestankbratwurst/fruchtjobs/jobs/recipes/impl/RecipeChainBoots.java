 ...
 *
 */
public class RecipeChainBoots extends AbstractJobShapedRecipe {

  public RecipeChainBoots(JobManager jobManager) {
    super(jobManager, JobType.CRAFTER, 0, JobPerkType.RECIPES_CHAINS);
    shape = new String[]{"C C", "C C"};
    desc = new ArrayList<>();
  ...
  public ItemStack getResult() {
    return ItemLibrary.CHAIN_BOOTS.getItem();
  }
